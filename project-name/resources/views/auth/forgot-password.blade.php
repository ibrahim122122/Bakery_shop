...
<body>
  <main class="auth-card">
    <section class="auth-hero">
      ...
      <h1 class="hero-title">Forgot your password?<br />Let's fix that.</h1>
      <p class="hero-copy">Enter your email address and we'll send you a link to reset your password and get back into your account.</p>
    </section>
    ...
    <section class="auth-panel">
      ...
      <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="links">
          ...
          <span class="muted">Secure password recovery.</span>
        </div>
      </form>
    </section>
  </main>
